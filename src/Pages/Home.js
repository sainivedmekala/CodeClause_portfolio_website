                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">SAI NIVED</b>
                      ...
                      <div className="about-social-icon text-center">
                        <ul className="about-social">
                          <li className="wow fadeIn" data-wow-delay=".4s">
                            <a
                              href="https://www.linkedin.com/in/sai-nived-mekala-026771247/"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".2s">
                            <a
                              href="https://github.com/sainivedmekala/"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".6s">
                            <a
                              href="https://www.instagram.com/sainived_mekala/"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".8s">
                            <a
                              href="https://twitter.com/sainivedmekala"
                              target="newtab"
                            >
                              <i
                ...
                <div className="row">
                  <div className="col-md-4 col-sm-6 col-xs-12 about-col">
                    <div className="about-image">
                      <img
                        src="https://www.linkpicture.com/q/PASSPHOTO.jpg"
                        alt="sainived"
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".2s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Completed my school life from Ekashila Public School
                          (E.P.S), Jangaon,Telangana, India.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="resume-details" data-wow-delay=".3s">
                      ...
                      <div className="resume-main">
                        ...
                        <p>
                          ...
                          >
                            KL UNIVERSITY(KONERU LAXMAIAH UNIVERSITY )
                          </a>
                            ...
                            >
                              ...
                              <div className="carousel-inner">
                                <div className="active item">
                                  <blockquote>
                                    <p>
                                      “SAINIVED was a real pleasure to work with
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “SAINIVED's a clear communicator with the
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “SAINIVED has done a fantastic job overall.
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".4s">
                        ...
                        >
                          contact.sainivedmekala@gmail.com
                        </a>
                      </div>
                    </div>
                    <div className="col-md-3 col-sm-6 contact-colamn">
                    ...
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".6s">
                        ...
                        ></i>
                        <h3>Portfolio</h3>
                        <p>https://github.com/sainivedmekala</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-12 col-sm-12 map-col">
                    <div class="google-maps">
                      <div class="map-wrap">
                        <iframe
                          title="google-maps"
                          src="https://maps.google.com/maps?width=791&amp;height=543&amp;hl=en&amp;q=aziz%20nagar%20Hyderabad+(kl%20university%20hyderabad)&amp;t=h&amp;z=13&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                          width="100%"
                          height="450"
                          style={{ border: "0" }}
                          allowfullscreen=""
